...
function Form() {
    ...
    const donationSchema = yup.object({
        ...
        nric : yup.string().required().matches(/^[TFSG]\d{7}[A-Z]$/,"NRIC format is not valid"),
            ...
            <div className="w-5/6 md:w-2/3 bg-white rounded shadow-2xl p-8 m-4">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="flex flex-col mb-4">
                        ...
                        <input {...register("donation")} className="border py-2 px-3 text-grey-800" type="text" />
                    ...
                    <div className="flex flex-col mb-4">
                        ...
                        <input {...register("email")} className="border py-2 px-3 text-grey-800" type="email"/>
                        <p className="text-red-400 text-xs italic">{input.email || isSubmit ? errors.email?.message : null}</p>
                    </div>

                    <div className="flex flex-col mb-4">
                        <label className="mb-2 font-bold text-lg text-gray-900" >Fullname</label>
                        <input {...register("fullname")} className="border py-2 px-3 text-grey-800" type="text" />
                        <p className="text-red-400 text-xs italic">{input.fullname || isSubmit ? errors.fullname?.message : null}</p>
                    </div>

                    <div className="flex flex-col mb-4">
                        <label className="mb-2 font-bold text-lg text-gray-900" >NRIC</label>
                        <input {...register("nric")} className="border py-2 px-3 text-grey-800" type="text" />
                    ...
                    <div className="flex flex-col mb-4">
                        ...
                        <input {...register("phone_number")} className="border py-2 px-3 text-grey-800" type="text" />
                    ...
                    <div className="flex flex-col mb-4">
                        ...
                        <textarea {...register("address")} className="border py-2 px-3 text-grey-800" ></textarea>
